package cn.example.life.service.api.user;
...
public interface UserService {
    ...
    @PostMapping(value = "/user/add", produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/user/find/{id}", produces = APPLICATION_JSON_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/user/find/all", method = RequestMethod.GET, produces = APPLICATION_JSON_VALUE)
    List<User> findAll();
